...
import { API_URL, ERROR_MESSAGES, INPUT_CLS, REGION_LEVEL_TH, SELECT_CLS, errorText } from '../lib/shared'
  ...
  return (
    <div className="py-2 h-screen flex flex-col gap-2 w-1/2 self-center overflow-y-hidden">
      <div className="bg-white border-0 rounded-2xl p-6">
        <h2 className="text-lg font-semibold text-brand font-title">ผู้ดูแล</h2>
      </div>
