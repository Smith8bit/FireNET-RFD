...
import { ArrowsPointingOutIcon, UserGroupIcon, ChevronDoubleRightIcon, ChevronDoubleLeftIcon } from '@heroicons/react/20/solid'
...
export default function MapViewPage() {
  ...
  return (
    <div className="flex flex-1 w-full overflow-hidden">
      <div className={`relative h-full transition-all duration-200 ${listCollapsed ? 'w-full' : 'w-3/4'}`}>
      ...
      <div className={`relative h-full transition-all duration-200 ${listCollapsed ? 'w-0' : 'w-1/4'}`}>
        ...
        <div
          className={`h-full bg-background overflow-hidden flex-col ${listCollapsed ? 'hidden' : 'flex'}`}
          id="map-controller"
        >
          <div id="list-controls" className="px-3 py-2 space-y-2 bg-white border-b border-gray-300">
            <div className="flex items-center justify-between">
              <p className="font-semibold text-md text-primary ">รายการไฟ ({listFires.length})</p>
